// File Path: app/specialoffers/page.js "important message for gemini ai"
        ...
        <>
            ...
            <div className={`nav-bar-container ${navOpen ? 'open' : ''}`}>
                <div className="expanded-menu">
                    <div onClick={() => router.push('/specialoffers')} className="nav-item active">
                        <i style={{ background: '#fffbeb', width: '35px', height: '35px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '4px' }}>🎁</i>
                        <span style={{ fontSize: '0.6rem' }}>{t.navOffers}</span>
                    </div>
